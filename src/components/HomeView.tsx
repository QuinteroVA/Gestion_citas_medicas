  ...
  return (
    <section className="pb-4 pt-4 text-center">
      ...
      <div className="mx-auto mt-10 grid max-w-2xl gap-6 md:grid-cols-2">
        <button onClick={onGoRegistro} className="rounded-2xl border border-slate-200 bg-white p-10 text-left shadow-lg">
        ...
        <button onClick={onGoReportes} className="rounded-2xl border border-slate-200 bg-white p-10 text-left shadow-lg">
          <div className="mx-auto flex h-15 w-15 items-center justify-center">
